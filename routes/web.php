...
Route::group(['namespace' => 'Sharefood', 'as' => 'sharefood.'], function () {
    ...
    Route::group(['prefix' => 'profile', 'as' => 'profile.'], function () {
        ...
        Route::get('create_food/{place}', ['as' => 'createFood', 'uses' => 'ProfileController@createFood'])->where('place', '[0-9]+');
        Route::post('create_food', ['as' => 'storeFood', 'uses' => 'ProfileController@storeFood']);
    });
