    ...
    <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h2><strong>Update Infomation</strong> {{ $staff->firstname }}</h2>
        </div>
        <div class="panel-body">
          <form action="{{ route('admin.staffs.update', ['staff' => $staff->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal ">
            {{ csrf_field() }}
            <div class="form-group">
              <label class="col-md-3 control-label">ID staff</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="email" id="email-input" name="email" class="form-control" placeholder="Enter Email" value="{{ $staff->email }}">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" id="disabled-input" name="firstname" class="form-control" placeholder="Firstname" value="{{ $staff->firstname }}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 control-label" for="disabled-input">Type</label>
              <div class="col-md-9">
                <input type="text" id="disabled-input" name="type" class="form-control" placeholder="Type" value="{{ $staff->type }}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 control-label" for="disabled-input">Lastname</label>
              <div class="col-md-9">
                <input type="text" id="disabled-input" name="lastname" class="form-control" placeholder="Lastname" value="{{ $staff->lastname }}">
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-3 control-label" for="disabled-input">Date of birth</label>
              <div class="col-md-9">
                <input type="text" id="disabled-input" name="date_of_birth" class="form-control" placeholder="Date of birth" value="{{ $staff->date_of_birth }}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select id="select" name="prefecture_id" class="form-control" size="1">
                  ...
                  @php
                    $selected = ($prefecture->id == $staff->prefecture_id)? 'selected="selected"':'';
                  @endphp
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" id="disabled-input" name="address" class="form-control" placeholder="Address" value="{{ $staff->address }}">
              </div>
            </div>
            <div class="form-group">
