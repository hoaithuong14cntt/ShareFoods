            ...
            <div class="modal-content content">
                <div class="wrp-ctn">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('sharefood.auth.login') }}" data-toggle="validator" role="form" name="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
                            {{ csrf_field() }}
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content content">
                <div class="wrp-ctn">
                    ...
                    <div class="modal-body">
                        <form data-toggle="validator" role="form" name="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
                            <div class="col-md-12 username">
                                <div class="form-group item">
